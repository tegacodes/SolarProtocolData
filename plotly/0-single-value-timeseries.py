...
apiDst = 'http://solarprotocol.net/api/v2/opendata.php?value=PV-power-L&duration=3'
...
def main():
    ...
    fig = px.bar(x=xTS, y=yVal, color=yVal, template="presentation", title="PV Power",labels=dict(x="PV Power", y="Time"))
    fig.show()
